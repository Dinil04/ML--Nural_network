...
#Get the vehicles dataset loaded
vehicles_data <- read_xlsx("C:/Users/dinil/Desktop/ML CW/vehicles.xlsx")

#Output variable removed (class attribute)
vehicles_data <- vehicles_data[, 2:19]
boxplot(vehicles_data, main = "Before Outlier Removal", outcol="orange")
View(vehicles_data)
...
boxplot(vehicles_data, main = "After Outlier Removal", outcol="orange")

#Data scaling through standards
...
abline(v = avg_sil_width, lty = 2, lwd =2,col="orange")
